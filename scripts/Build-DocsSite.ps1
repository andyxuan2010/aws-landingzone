...
$cardMarkup = ($pages | ForEach-Object {
    $href = "docs/$($_.OutputPath)"
    "<a class=`"doc-card`" data-search-card href=`"$href`"><h3>$(Encode-Html $_.Title)</h3><p>$(Encode-Html $_.Summary)</p><span class=`"doc-meta`">Read document →</span></a>"
}) -join "`n"
...
"@
Write-Utf8File (Join-Path $outputRoot "index.html") (Render-Page $indexContent $siteTitle "index.html" $true)
